...
3. [Open the HFN-Mango Project in VSCode to write samrt contract](https://github.com/LifnaJos/Hyperledger-Fabric-Network-Go-Lang/blob/main/Setup-HFN.md#step---3--open-the-hfn-mango-project-in-vscode-to-write-smart-contract)
