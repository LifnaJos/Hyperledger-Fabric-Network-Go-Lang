# SetUp a Hyperledger Fabric Network
#### Acknowledgements
...
## **Objective** : 
1. To take a walkthrough the [insallation of Packages](https://github.com/LifnaJos/Hyperledger-Fabric-Network-Go-Lang#step-1--insallation-of-packages)
2. To [bootstraping the Hyperledger Fabric Network using IBM Microfab](https://github.com/LifnaJos/Hyperledger-Fabric-Network-Go-Lang#step-2--bootstraping-the-network-using-ibm-microfab)
3. To [understand the key terminologies in Hyperledger Fabric Network]()
4. To [understand the Use-case scenario - Tracing mangoes]()
5. To [set up a small Multi-org based Hyperledger Fabric Network in Go Lang]()
  

## 1. Understanding Key Terminologies in Hyperledger Fabric Network
...
## 2. Use-Case Scenario : To trace mangoes 
